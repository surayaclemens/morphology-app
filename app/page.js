    ...
    <div>
      ...
      {/* HERO */}
        <div className='flex flex-col justify-center items-center space-y-6'>
          <Image alt='Morphology' src='/wordmark-white.png' width='960' height='300'/>
          <h3 className='text-white text-center text-xl lg:text-3xl'>is a fun and easy way to learn your heritage language!</h3>
          <Image className='' alt='tetris blocks' src='/tetris-desktop.png' width='800' height='360'/>
        </div>
        ...
        <div className='flex flex-col justify-center items-center space-y-8 relative lg:py-8'>
          ...
          <Image className='md:absolute right-16 lg:right-72 xl:right-1/4' alt='question mark illustration' src='/question-girl.svg' width='275' height='350'/>
      ...
      <section className='bg-lilac flex flex-col justify-center items-center space-y-16 px-8 py-16 md:py-32'>
        ...
        <div className='flex flex-col lg:flex-row justify-center lg:space-x-16 xl:space-x-24'>
          ...
          <div className='flex flex-col justify-start items-center space-y-8'>
            ...
            <div className='bg-midnight rounded-lg p-4 flex justify-center items-center text-center text-white w-72 h-52'>
      ...
      {/* SECTION WITH PURPLE BG */}
      <section className='bg-lilac flex flex-col justify-center items-center text-center px-8 py-24 space-y-4'>
        ...
        <p className='text-midnight text-lg lg:text-xl md:w-2/3'>We’ve got a great app under development, but you can’t play juust yet.</p>
        <p className='text-midnight text-lg lg:text-xl md:w-2/3'>We’d be glad to let you know when you can!</p>
